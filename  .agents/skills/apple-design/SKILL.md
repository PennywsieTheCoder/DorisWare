...
> "When we align the interface to the way we move and react to our world, the screen disappears. We're no longer manipulating pixels through an intermediary; we are interacting with physical objects themselves."
