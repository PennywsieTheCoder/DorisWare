...
export default function Categories({ onCategoryChange }) {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 pb-10 pt-6 sm:px-6 sm:pt-8">
      ...
      <div className="grid grid-cols-2 gap-x-3 gap-y-6 min-[360px]:grid-cols-3 sm:grid-cols-5 sm:gap-x-5">
        {loading ? (
          <div className="col-span-full w-full py-10 text-center text-sm text-stone-500 dark:text-stone-400">Loading categories…</div>
          ...
          return (
            ...
            >
              <span className="relative block h-20 w-20 overflow-hidden rounded-full border-2 border-white bg-stone-100 shadow-md ring-1 ring-stone-200 transition duration-300 group-hover:-translate-y-1 group-hover:scale-105 group-hover:ring-amber-400 dark:bg-stone-800 dark:ring-stone-700 sm:h-28 sm:w-28">
                <img
