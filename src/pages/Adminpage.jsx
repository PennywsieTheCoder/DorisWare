...
export default function AdminPage() {
  ...
  async function loadDashboard() {
    setLoading(true);
    setError("");
    const [productsResult, categoriesResult, zonesResult, bannerResult, ordersResult, reviewsResult, aboutResult] = await Promise.all([
    ...
    if (productsResult.error || categoriesResult.error || zonesResult.error || bannerResult.error || ordersResult.error || reviewsResult.error || aboutResult.error) {
  ...
  }, [activeSection, editingProduct, editingCategory, promoBanner, aboutContent]);
