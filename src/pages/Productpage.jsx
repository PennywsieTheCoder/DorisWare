      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_.95fr] lg:items-start lg:gap-14">
          ...
          <section className="rounded-[2rem] bg-white p-6 shadow-sm dark:bg-stone-900 sm:p-8">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-3"><div className="flex items-center gap-1 rounded-full bg-amber-50 px-3 py-1.5 text-sm font-medium text-amber-800 dark:bg-amber-950/40 dark:text-amber-300"><Star size={15} className={product.reviewCount ? "fill-amber-400 text-amber-400" : "text-amber-400"} /> {product.reviewCount ? product.ratingAverage.toFixed(1) : "New"} <span className="text-amber-700/70 dark:text-amber-300/70">({product.reviewCount || 0} reviews)</span></div><span className="flex items-center gap-2 text-sm text-emerald-700 dark:text-emerald-400"><span className="h-2 w-2 rounded-full bg-emerald-500" /> Ready to dispatch</span></div>
