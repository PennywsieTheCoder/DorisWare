...
export default function ProductPage() {
  ...
  const originalPrice = Number(product.price.replace(/[^0-9.]/g, "")) * 1.2;
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_.95fr] lg:items-start lg:gap-14">
          ...
          <section className="rounded-[2rem] bg-white p-6 shadow-sm dark:bg-stone-900 sm:p-8">
            ...
            <div className="mt-7 flex items-end gap-3 border-y border-stone-100 py-6 dark:border-stone-800"><span className="text-3xl font-bold text-stone-900 dark:text-stone-100">{product.price}</span><span className="mb-1 text-sm text-stone-400 line-through">{money(originalPrice)}</span><span className="mb-1 rounded-md bg-emerald-100 px-2 py-1 text-xs font-bold text-emerald-800 dark:bg-emerald-950/40 dark:text-emerald-300">Save 20%</span></div>
